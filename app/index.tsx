...
import { useSharedValue, withTiming, Easing, withSequence, useFrameCallback, useDerivedValue, interpolate, Extrapolation, useAnimatedReaction, runOnJS, cancelAnimation } from "react-native-reanimated";
...
const App = () => {
  ...
  const isPointCollidingWithRect = (point: { x: any; y: any }, rect: { x: any; y: any; h: any; w: any }) => {
    "worklet";
    return (
    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <GestureDetector gesture={gesture}>
        <Canvas style={{ width, height }}>
          {/* BG */}
          <Image image={bg} width={width} y={100} height={height} fit={"cover"} />
          ...
          {/* Base */}
          <Image image={base} width={width} height={150} y={height - 150} x={0} fit={"cover"} />
